...
const Loading: React.FC<LoadingProps> = ({ text = 'Carregando...' }) => {
    return (
        <div className="fixed inset-0 flex flex-col items-center justify-center w-full h-full bg-white" role="presentation">
            <div className="relative" data-testid="loading-animation">
