...
function DashboardPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="flex">
                {/* Sidebar */}
                <div className={`${isSidebarOpen ? 'block' : 'hidden'} md:block w-64 bg-white shadow-sm`}>
                                ...
                                <li>
                                    <div className="px-4 py-4 sm:px-6">
                                        <div className="flex items-center justify-between">
                                            <p className="text-sm font-medium text-indigo-600 truncate">New user registration</p>
