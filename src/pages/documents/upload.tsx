        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <motion.div
              ...
              className="bg-component-bg-light dark:bg-component-bg-dark rounded-xl shadow-sm p-6 space-y-6 border border-gray-100 dark:border-gray-700"
            >
              <div>
                ...
                <div className="relative">
                  ...
                  <div className="space-y-4">
                    <div className="relative pl-8">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-300">Selecione o arquivo PDF</p>
                    </div>
                    <div className="relative pl-8">
                      <div className="absolute left-0 top-1 w-2 h-2 rounded-full bg-green-500 dark:bg-green-400"></div>
                      <p className="text-sm text-gray-600 dark:text-gray-300">Clique em &quot;Enviar Documento&quot;</p>
                    </div>
                    <div className="relative pl-8">
                      <div className="absolute left-0 top-1 w-2 h-2 rounded-full bg-green-500 dark:bg-green-400"></div>
                      <p className="text-sm text-gray-600 dark:text-gray-300">Aguarde o processamento</p>
                    </div>
                    <div className="relative pl-8">
                      <div className="absolute left-0 top-1 w-2 h-2 rounded-full bg-green-500 dark:bg-green-400"></div>
                      <p className="text-sm text-gray-600 dark:text-gray-300">Documento pronto para assinatura</p>
                    </div>
                  </div>
                </div>
              </div>
